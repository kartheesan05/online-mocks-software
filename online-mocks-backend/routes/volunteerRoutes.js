...
// Get allocated HRs
router.get("/allocated-hrs", auth, checkRole(["volunteer"]), async (req, res) => {
  try {
...
// Add student
router.post("/add-student", auth, checkRole(["volunteer"]), async (req, res) => {
  try {
...
router.get("/students/:hrId", auth, checkRole(["volunteer"]), async (req, res) => {
  try {
...
router.post("/deallocate-student/:studentId/:hrId", auth, checkRole(["volunteer"]), async (req, res) => {
  try {
